...
namespace MagicVilla_VillaAPI.Controllers.v1
{
    ...
    public class VillaNumberAPIController : ControllerBase
    {
        ...
        public VillaNumberAPIController(IVillaNumberRepository dbVillaNumber, IMapper mapper, IVillaRepository dbVillaRepository)
        {
        ...
        public async Task<ActionResult<APIResponse>> CreateVillaNumber([FromBody] VillaCreateNumberDTO createDTO)
        {
            try
            {
                ...
                if (await _dbVillaRepository.GetAsync(x => x.Id == createDTO.VillaId) == null)
                {
        ...
        public async Task<ActionResult<APIResponse>> UpdateVillaNumber(int id, [FromBody] VillaUpdateNumberDTO updateDTO)
        {
            try
            {
                ...
                if (await _dbVillaRepository.GetAsync(x => x.Id == updateDTO.VillaId) == null)
                {
                    ModelState.AddModelError("ErrorMessages", "Villa ID is Invalid!");
                    return BadRequest(ModelState);
                }
